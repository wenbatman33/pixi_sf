...
export default class Application extends PIXI.Application {
  ...
  load() {
    ...
    loader.onStart.add(() => this.emit('loader:start'))
    loader.onProgress.add((loader, res) => this.emit('loader:progress', parseInt(loader.progress)))
    loader.onLoad.add((loader, res) => this.emit('load:res', res.url))
    loader.onError.add((err, loader, res) => this.emit('loader:error', res.url))
